...
CREATE TABLE IF NOT EXISTS TICKERS (
	...
	ASK_LOT_VOLUME          DECIMAL(30,10),
    BID_PRICE		        DECIMAL(30,10),
	BID_WHOLE_LOT_VOLUME    INT,
	BID_LOT_VOLUME          DECIMAL(30,10),
    LAST_CLOSED_PRICE		DECIMAL(30,10),
	LAST_CLOSED_LOT_VOLUME  DECIMAL(30,10),
    VOLUME_TODAY		    DECIMAL(30,10),
	VOLUME_LAST_24          DECIMAL(30,10),
    VOLUME_WEIGHTED_AVERAGE_TODAY		DECIMAL(30,10),
	VOLUME_WEIGHTED_AVERAGE_LAST_24     DECIMAL(30,10),
    NUMBER_TRADES_TODAY		DECIMAL(30,10),
	NUMBER_TRADES_LAST_24   DECIMAL(30,10),
    LOW_TODAY		        DECIMAL(30,10),
	LOW_LAST_24             DECIMAL(30,10),
    HIGH_TODAY		        DECIMAL(30,10),
	HIGH_LAST_24            DECIMAL(30,10),
